...
<div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-3xl mx-auto">
    <form action="dashboard.php?page=store_dosen" method="POST" enctype="multipart/form-data" class="space-y-5">
        ...
        <div>
            ...
            <input type="file" name="gambar" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100 cursor-pointer">
        </div>

        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-bold text-gray-700 mb-2">NIDN</label>
                <input type="text" name="nidn" class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-orange-500 outline-none">
            </div>
            <div>
        ...
        <div class="border-t pt-4 mt-4">
            ...
            <div class="space-y-3">
                <div class="flex items-center">
                    ...
                    <input type="text" name="link_instagram" placeholder="Link Instagram" class="flex-1 px-4 py-2 rounded-xl border border-gray-200 focus:border-orange-500 outline-none text-sm">
                </div>
                <div class="flex items-center">
                    <span class="w-10 text-center text-blue-600 text-xl"><i class="fab fa-linkedin"></i></span>
                    <input type="text" name="link_linkedin" placeholder="Link LinkedIn" class="flex-1 px-4 py-2 rounded-xl border border-gray-200 focus:border-orange-500 outline-none text-sm">
                </div>
                <div class="flex items-center">
                    <span class="w-10 text-center text-gray-800 text-xl"><i class="fab fa-github"></i></span>
                    <input type="text" name="link_github" placeholder="Link GitHub" class="flex-1 px-4 py-2 rounded-xl border border-gray-200 focus:border-orange-500 outline-none text-sm">
                </div>
            </div>
        </div>

        <div class="pt-4 flex justify-end">
            <button type="submit" class="px-8 py-3 rounded-xl bg-orange-600 text-white hover:bg-orange-700 font-bold shadow-lg transform hover:-translate-y-0.5 transition">Simpan Data</button>
        </div>
    </form>
</div>