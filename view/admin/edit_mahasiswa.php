...
<div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 max-w-3xl mx-auto">
    ...
    <form action="dashboard.php?page=update_mahasiswa" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="nim" value="<?= htmlspecialchars($student['nim']) ?>" required 
                class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-orange-500 outline-none font-mono bg-gray-50">
        </div>
        ...
        <div class="pt-4 flex justify-end">
            <button type="submit" class="px-8 py-3 rounded-xl bg-orange-600 text-white hover:bg-orange-700 font-bold transition shadow-lg">
                Simpan Perubahan
            </button>
        </div>
