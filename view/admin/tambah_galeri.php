...
<form action="dashboard.php?page=store_galeri" method="POST" enctype="multipart/form-data" class="space-y-8">
    ...
    <div class="w-full">
        <label for="upload-galeri" class="flex flex-col items-center justify-center w-full h-80 border-2 border-gray-300 border-dashed rounded-3xl cursor-pointer bg-gray-100 hover:bg-gray-200 transition relative overflow-hidden group">
            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-gray-500 group-hover:text-gray-600 z-10">
                <p class="mb-2 text-lg font-semibold">Upload Gambar Galeri</p>
                <i class="fas fa-cloud-upload-alt text-5xl text-gray-400 mt-2"></i>
            </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        ...
        <textarea name="deskripsi" rows="5" placeholder="Berikan deskripsi tentang gambar ini..." required 
                  class="w-full px-6 py-4 bg-gray-50 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition resize-none border border-gray-200"></textarea>
    </div>
