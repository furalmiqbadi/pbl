    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <?php if (!empty($data)): ?>
            <?php foreach ($data as $item): ?>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl flex flex-col h-full">
                    
                    <div class="h-56 relative group">
                        <img src="<?= $gambar ?>" alt="Galeri" class="object-cover w-full h-full transition duration-500 group-hover:scale-110">
                    ...
                    <div class="bg-white p-5 flex flex-col flex-1">
                        ...
                        <div class="border-t border-gray-100 pt-4 mt-auto">
                            <span class="text-xs font-medium text-orange-500 bg-orange-50 px-2 py-1 rounded">
                                Galeri MMT
                            </span>
                        </div>
                    </div>
