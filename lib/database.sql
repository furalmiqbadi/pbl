...
(
    ...
    nama_pt character varying(255) COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS public.dosen_multimedia
    ADD CONSTRAINT dosen_multimedia_prodi_id_fkey FOREIGN KEY (prodi_id)
